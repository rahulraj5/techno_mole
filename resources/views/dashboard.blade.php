					...
					<div class="col">
						<div class="card radius-10 bg-danger bg-gradient">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0 text-white">Orders Completed</p>
					...
					<div class="col">
						<div class="card radius-10 bg-warning bg-gradient">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0 text-dark">Total Orders Value</p>
					...
					<div class="col">
						<div class="card radius-10 bg-success bg-gradient">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0 text-white">Total Store Visitors</p>
						 ...
						 <div class="table-responsive">
						   <table class="table align-middle mb-0">
							<thead class="table-light">
							 ...
							 <tbody><tr>
							  <td>Shirts</td>
							  <td><img src="http://artybrainsdemo.com/mole/images/product/10-07-2021/shirt_blue.jpeg" class="product-img-2" alt="product img"></td>
							  <td>#9405822</td>
							 ...
							 <tr>
							  <td>T-Shirts</td>
							  <td><img src="http://artybrainsdemo.com/mole/images/product/10-07-2021/tshirt-yellow.webp" class="product-img-2" alt="product img"></td>
							  <td>#8304620</td>
							 ...
							 <tr>
							  <td>Jeens</td>
							  <td><img src="http://artybrainsdemo.com/mole/images/product/10-07-2021/jeens_blue.jpg" class="product-img-2" alt="product img"></td>
							  <td>#4736890</td>
