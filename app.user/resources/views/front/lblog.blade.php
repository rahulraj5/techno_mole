                ...
                <section class="blog-category">
                  ...
                  <div id="blogarticle-container" class="collapse data-toggler">
                    <div class="description clearfix">
                      <div class="blog-artical">
                        <a href="#" title="Upon of seasons earth dominion">
                          <img alt="Upon of seasons earth dominion" src="{{asset('assets/images/blog/1.jpg')}}">
                        </a>
                      </div>
                      <div class="blog-desc">
                    ...
                    <div class="description clearfix">
                      <div class="blog-artical">
                        <a href="#" title="Upon of seasons earth dominion">
                          <img alt="Upon of seasons earth dominion" src="{{asset('assets/images/blog/2.jpg')}}">
                        </a>
                      </div>
                      <div class="blog-desc">
                    ...
                    <div class="description clearfix">
                      <div class="blog-artical">
                        <a href="#" title="Upon of seasons earth dominion">
                          <img alt="Upon of seasons earth dominion" src="{{asset('assets/images/blog/4.jpg')}}">
                        </a>
                      </div>
                      <div class="blog-desc">
                    ...
                    <div class="description clearfix">
                      <div class="blog-artical">
                        <a href="#" title="Upon of seasons earth dominion">
                          <img alt="Upon of seasons earth dominion" src="{{asset('assets/images/blog/8.jpg')}}">
                        </a>
                      </div>
                      <div class="blog-desc">
                    ...
                    <div class="description clearfix">
                      <div class="blog-artical">
                        <a href="#" title="Upon of seasons earth dominion">
                          <img alt="Upon of seasons earth dominion" src="{{asset('assets/images/blog/6.jpg')}}">
                        </a>
                      </div>
                      <div class="blog-desc">
            ...
            <div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-9"> 
              ...
              <div class="sdsarticleCat clearfix row">
                  ...
                  <div class="articleContent col-xl-6 col-lg-6 col-md-12">
                    <a href="#" title="Upon of seasons earth dominion">
                      <img alt="Upon of seasons earth dominion" src="{{asset('assets/images/banner/'.$blg->image)}}">
                    </a>
                  </div>
                  <div class="smartblog-desc col-xl-6 col-lg-6 col-md-12">
                    ...
                    <span class="blogdetail">       
                      ...
                      <span class="blogcomment"><a title="0 Comments" href="#"><i class="fa fa-comments"></i>&nbsp;&nbsp;{{$blg->	no_of_comments}}  Comments</a></span>
                      &nbsp;
                    ...
                    <div class="sdsreadMore">
                      <span class="more">
                        <a title="Upon of seasons earth dominion" href="/blog_info/{{$blg->id}}" class="r_more btn-primary">Read more</a>
                      </span>
                    </div>
                  </div>
                </div>
