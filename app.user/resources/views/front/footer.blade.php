            ...
            <div id="ishistoreinfo" class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
              <div id="ishistoreinfo-container" class="ishistoreinfo-inner">
                <a href="index.html" class="store-logo">
                  <img src="{{asset('assets/images/moleLogo.png')}}" alt="footer-logo">
                </a>
            ...
            <div id="_desktop_storeinfo" class="block-contact col-lg-3 col-md-12 col-sm-12 col-xs-12 footer-block">
              ...
              <div id="contact-info-container" class="footer-contact">
                <div class="block address col-lg-12 col-md-4 col-sm-4 col-xs-12">
                  ...
                  <div class="content">Demo Shop<br>01 Demo Street<br>France</div>
                </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div id="ishispecialdeals-icon">
              <div id="ishispecialdeal" class="ishispecialdeals">
                <div id="ishispecialdeals-carousel" class="owl-carousel">
                  <div class="item product-thumb" data-countdowntime="2020-11-30">
                    <div class="row">
                      <div class="image col-lg-5 col-md-5 col-sm-5 col-xs-5">
                        <a href="#" class="thumbnail product-thumbnail">
                          <img src="{{asset('assets/images/product/1.jpg')}}" alt="product-img">
                          <img class="product-img-extra change" alt="product-img" src="{{asset('assets/images/product/2.jpg')}}">
                        </a>
                      </div>   
                      <div class="caption col-lg-7 col-md-7 col-sm-7 col-xs-7">
                        <h3>Best Deals</h3>
                        <div class="product-title"><a href="#">Aroma Mocha</a></div> 
                        <p class="price">
                        ...
                        <div class="button-group">  
                          ...
                          <div class="btn-cart">
                            <a href="#">
                              ...
                              <svg class="icon" viewBox="0 0 30 30"><use xlink:href="#addtocart" x="28%" y="28%"></use></svg>
                  ...
                  <div class="item product-thumb" data-countdowntime="2020-12-30">
                    <div class="row">
                      <div class="image col-lg-5 col-md-5 col-sm-5 col-xs-5">
                        <a href="#" class="thumbnail product-thumbnail">
                          <img src="{{asset('assets/images/product/4.jpg')}}" alt="product-img">
                          <img class="product-img-extra change" alt="product-img" src="{{asset('assets/images/product/5.jpg')}}">
                        </a>
                      </div>   
                      <div class="caption col-lg-7 col-md-7 col-sm-7 col-xs-7">
                        <div class="product-title"><a href="#">Comdaq Stroller</a></div> 
                        <p class="price">
  ...
  $.ajax({
            ...
            success:function(result) {
              ...
              if(result['data'] != null){
               ...
               $("#message").html(item.price);
               $("#ajax_descrip").html(item.en_description);
               $("#add_cart_hide").show();
                $("#add_wish_hide").show();
                $("#quantity_hide").show();
             });
...
$('input[type=radio]').on('change', function(e) {
  ...
  $.ajax({
   ...
   //ajax use for update cart
   $(".update-cart").change(function (e) {
        e.preventDefault();
  
        var ele = $(this);
        var f = ele.parents("tr").attr("data-id");
...
<!-- Mirrored from demo.ishithemes.com/html/toytown/Layout001/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 May 2021 08:33:17 GMT -->
</html>