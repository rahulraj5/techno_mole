                        ...
                        <li @if ($key === 0) class="active" @endif data-depth="0">
                          ...
                          <div class="collapse" id="exCollapsingNavbar4{{$key+1}}">
                            ...
                            @foreach($subcategory as $subcats)
                              <li data-depth="1">
                               <a class="category-sub-link" href="/bycatpro/{{$cat->id}}/{{$subcats->id}}">{{$subcats->name}}</a>
                               </li>
                               @endforeach
                ...
                <div id="product-list-top">
                  <div id="js-product-list-top" class="row products-selection">
                    <div class="col-lg-6 total-products">
                      ...
                      <p>There are {{$wordCount}} products.</p>                    </div>
                    <div class="col-lg-6">
                ...
                <div id="js-product-list">
                  ...
                  @foreach($product as $pro)
                      ...
                      <div class="product-container product-thumb">
                        ...
                        <div class="caption">
                          <p class="price">
                          <span class="price-sale">MRP</span>  <span class="price-sale"><del>{{$pro->mrp}}</del> </span><i class="fa fa-rupee-sign"></i>&nbsp&nbsp&nbsp
                          <span class="price-sale">Price</span>  <span class="price-sale">{{$pro->price}} </span><i class="fa fa-rupee-sign"></i><br>
                          ...
                          <span class="price-sale" style="color:red;">Save_off</span>  <span class="price-sale" style="color:red;">{{$pro->mrp - $pro->price}} </span><i class="fa fa-rupee-sign"></i><BR>
                          ...
                          <div class="button-group">
                            ...
                            <a class="quickbox" href="/detail/{{$pro->product_id}}">                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
