...
@section('content')
    ...
    <div id="top_home">
      ...
      <section id="ishislider" class="ishislider-container owl-carousel">
        ...
        <div class="item">
          <a href="#">
            <img src="{{asset('../'.$im->banner_image)}}" alt="Slide-1" height="550px" class="img-responsive">
          </a>
        </div>
        @endforeach
        <!-- <div class="item">
          <a href="#">
            <img src="{{asset('assets/images/slider/slide-2.png')}}" alt="Slide-2" class="img-responsive">
          </a>
        </div> -->
      </section>
       ...
       <section id="ishicategory" class="ishicategoryblock">
        ...
        @foreach($category as $cat)
          <div class="image-container"> 
            <div class="item">
              <a href="bycat/{{$cat->id}}">
                <img src="{{asset('../'.$cat->image)}}" height="120px" width="120px" alt="category-2" class="img-responsive" />
              </a>
        ...
        <div class="container"> 
          <div class="row">
            <div class="bannerleft col-md-4 col-sm-12">
              <div class="bannerblock">
                <a href="#" class="ishi-customhover-fadeinrotate3D">
                  <img src="{{asset('assets/images/banner/1.png')}}" alt="banner" class="img-responsive" />
                </a>  
              </div> 
            </div>
            <div class="bannercenter col-md-4 col-sm-12">
              <div class="bannerblock">
                <a href="#" class="ishi-customhover-fadeinrotate3D ">
                  <img src="{{asset('assets/images/banner/2.png')}}" alt="banner" class="img-responsive" />
                </a>  
              </div>
              <div class="bannerblock">
                <a href="#" class="ishi-customhover-fadeinrotate3D ">
                  <img src="{{asset('assets/images/banner/3.png')}}" alt="banner" class="img-responsive" />
                </a>  
              </div>
            </div>
            <div class="bannerright col-md-4 col-sm-12">
              <div class="bannerblock"> 
                <a href="#" class="ishi-customhover-fadeinrotate3D ">
                  <img src="{{asset('assets/images/banner/4.png')}}" alt="banner" class="img-responsive" />
                </a>  
              </div>
            </div> 
          </div>
          ...
          <div id="featured-products-block" class="tab-pane active">
            <div class="block_content row">
              <div id="ishi-featured-products" class="owl-carousel">
                ...
                @if($ff->current_stock > 0)
                  <div class="product-thumb">
                  <div class="item">
                    <div class="product-desc">
                      <div class="product-title"><a href="#">{{$ff->name}}</a></div>
                    ...
                    <div class="image">
                      ...
                      <img src="{{asset('../'.$ff->varient_image)}}" alt="product-img">
                          <img class="product-img-extra change" alt="product-img" src="{{asset('../'.$ff->other_image)}}">
                      </a>
                    ...
                    <div class="caption">  
                      ...
                      {{$ff->en_description}}</p>
                      <p class="price">
                        <span class="regular price-old">{{$ff->mrp}}</span> 
                        <span class="price-discount">{{$ff->mrp - $ff->price}}</span> 
                        <span class="price-sale">{{$ff->price}}</span>
                      </p>
                      <div class="btn-cart">
                        <a href="direct_cart/{{$ff->varient_id}}/{{$ff->name}}" data-button-action="add-to-cart" class="button">
                      ...
                      <div class="button-group">  
                        ...
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$ff->product_id}}/{{$ff->varient_id}}">                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                        ...
                        <a href="direct_wish/{{$ff->varient_id}}/{{$ff->name}}">
                ...
                <div class="product-thumb">
                  <div class="item">
                    ...
                    <div class="caption">  
                      ...
                      <div class="button-group">  
                        <div class="btn-quickview"> 
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$ff->product_id}}/{{$ff->varient_id}}"> 
                            <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
...
<div class="product-thumb">
                  <div class="item">
                    ...
                    <div class="image">
                      <a href="#" class="thumbnail product-thumbnail">
                      <img src="{{asset('../'.$pro->varient_image)}}" alt="product-img">
                          <img class="product-img-extra change" alt="product-img" src="{{asset('../'.$pro->other_image)}}">
                      </a>
                      <div class="product-flags">
                        <div class="sale">Sale</div>
                      </div>
                    ...
                    <div class="caption">  
                      ...
                      <p class="price">
                        <span class="regular price-old">{{$pro->mrp}}</span> 
                        <span class="price-discount">{{$pro->mrp - $pro->price}}</span> 
                      ...
                      <div class="button-group">  
                        <div class="btn-quickview"> 
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$pro->product_id}}/{{$pro->varient_id}}">                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                  <symbol id="eye-open" viewBox="0 0 1190 1190">
                                    <title>eye-open</title>
                                    <path
                                      d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z" />
          ...
          <div id="bestseller-products-block" class="tab-pane">
            <div class="block_content row">
              <div id="ishi-bestseller-products" class="owl-carousel">
                 ...
                 @foreach($cart as $ff)
                @if($ff->current_stock > 0)<div class="product-thumb">
                  <div class="item">
                    <div class="product-desc">
                      <div class="product-title"><a href="#">{{$ff->name}}</a></div>
                      <div class="product-comments">  
                    ...
                    <div class="caption">  
                      ...
                      <div class="btn-cart">
                        <a href="direct_cart/{{$ff->pid}}/{{$ff->name}}" data-button-action="add-to-cart" class="button">
                              <i class="fa fa-shopping-cart"></i>
                              <span class="lblcart">Add to cart</span>
                            </a>
                      </div>                           
                      <div class="button-group">  
                        <div class="btn-quickview"> 
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$ff->product_id}}/{{$ff->pid}}">                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                  <symbol id="eye-open" viewBox="0 0 1190 1190">
                                    <title>eye-open</title>
                                    <path
                                      d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z" />
                        ...
                        <div class="btn-wishlist">
                        <a href="direct_wish/{{$ff->pid}}/{{$ff->name}}">
                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                  <symbol id="heart-shape-outline" viewBox="0 0 1400 1400">
                                    <title>heart-shape-outline</title>
                                    <path
...
@else
                <div class="product-thumb">
                  <div class="item">
                    ...
                    <div class="caption">  
                      ...
                      <div class="button-group">  
                        <div class="btn-quickview"> 
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$ff->product_id}}/{{$ff->pid}}"> 
                            <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                              <symbol id="eye-open" viewBox="0 0 1190 1190"><title>eye-open</title><path d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z"/></symbol>
                            </svg>
                            <svg class="icon" viewBox="0 0 30 30"><use xlink:href="#eye-open" x="28%" y="28%"></use></svg>
        ...
        <div class="bannerblock col-lg-3 col-md-3 col-sm-3 col-xs-6">
          <div class="image-container">
            <a href="#" class="ishi-customhover-fadeoutcenter ">
              <img src="{{asset('assets/images/gallery/1.jpg')}}" alt="banner-img" class="img-responsive"> 
            </a>
          </div>
        </div>
        <div class="bannerblock col-lg-3 col-md-3 col-sm-3 col-xs-6">
          <div class="image-container">
            <a href="#" class="ishi-customhover-fadeoutcenter ">
              <img src="{{asset('assets/images/gallery/2.jpg')}}" alt="banner-img" class="img-responsive"> 
            </a>
          </div>
        </div>
        <div class="bannerblock col-lg-3 col-md-3 col-sm-3 col-xs-6">
          <div class="image-container">
            <a href="#" class="ishi-customhover-fadeoutcenter ">
              <img src="{{asset('assets/images/gallery/3.jpg')}}" alt="banner-img" class="img-responsive"> 
            </a>
          </div>
        </div>
        <div class="bannerblock col-lg-3 col-md-3 col-sm-3 col-xs-6">
          <div class="image-container">
            <a href="#" class="ishi-customhover-fadeoutcenter ">
              <img src="{{asset('assets/images/gallery/4.jpg')}}" alt="banner-img" class="img-responsive"> 
            </a>
          </div>
        </div>
        <div class="bannerblock col-lg-3 col-md-3 col-sm-3 col-xs-6">
          <div class="image-container">
            <a href="#" class="ishi-customhover-fadeoutcenter ">
              <img src="{{asset('assets/images/gallery/5.jpg')}}" alt="banner-img" class="img-responsive"> 
            </a>
          </div>
        </div>
        <div class="bannerblock col-lg-3 col-md-3 col-sm-3 col-xs-6">
          <div class="image-container">
            <a href="#" class="ishi-customhover-fadeoutcenter ">
              <img src="{{asset('assets/images/gallery/6.jpg')}}" alt="banner-img" class="img-responsive"> 
            </a>
          </div>
        </div>
        <div class="bannerblock col-lg-3 col-md-3 col-sm-3 col-xs-6">
          <div class="image-container">
            <a href="#" class="ishi-customhover-fadeoutcenter ">
              <img src="{{asset('assets/images/gallery/7.jpg')}}" alt="banner-img" class="img-responsive"> 
            </a>
          </div>
        </div>
        <div class="bannerblock col-lg-3 col-md-3 col-sm-3 col-xs-6">
          <div class="image-container">
            <a href="#" class="ishi-customhover-fadeoutcenter ">
              <img src="{{asset('assets/images/gallery/8.jpg')}}" alt="banner-img" class="img-responsive"> 
            </a>
          </div>
        </div>
      </section> -->
      ...
      <!-- <section id="ishimanufacturerblock" class="clearfix container">
        <div id="manufacturer-carousel" class="owl-carousel">
            <div class="item">
                <div class="image-container">
                    <a href="#">
                        <img src="{{asset('assets/images/brand/logo1.png')}}" title="Fashion Manufacturer 1" alt="Fashion Manufacturer 1">
                    </a>
                </div>
            </div>
            <div class="item">
                <div class="image-container">
                    <a href="#">
                        <img src="{{asset('assets/images/brand/logo2.png')}}" title="Fashion Manufacturer 2" alt="Fashion Manufacturer 2">
                    </a>
                </div>
            </div>
            <div class="item">
                <div class="image-container">
                    <a href="#">
                        <img src="{{asset('assets/images/brand/logo3.png')}}" title="Fashion Manufacturer 3" alt="Fashion Manufacturer 3">
                    </a>
                </div>
            </div>
            <div class="item">
                <div class="image-container">
                    <a href="#">
                        <img src="{{asset('assets/images/brand/logo4.png')}}" title="Fashion Manufacturer 4" alt="Fashion Manufacturer 4">
                    </a>
                </div>
            </div>
            <div class="item">
                <div class="image-container">
                    <a href="#">
                        <img src="{{asset('assets/images/brand/logo5.png')}}" title="Fashion Manufacturer 5" alt="Fashion Manufacturer 5">
                    </a>
                </div>
            </div>
            <div class="item">
                <div class="image-container">
                    <a href="#">
                        <img src="{{asset('assets/images/brand/logo6.png')}}" title="Fashion Manufacturer 6" alt="Fashion Manufacturer 6">
                    </a>
                </div>
            </div>
        </div>
      ...
      <!-- <section id="ishispecialproducts" class="container">
        ...
        <div class="block_content row">
          <div id="ishispecialproducts-carousel" class="owl-carousel products">
            ...
            @if($disc->current_stock > 0)
            <div class="product-thumb">
                  <div class="item">
                    <div class="product-desc">
                      <div class="product-title"><a href="#">{{$disc->name}}</a></div>
                      <div class="product-comments">  
                        <div class="star_content">
                            <div class="star star_on"></div>
                            <div class="star star_on"></div>
                    ...
                    <div class="image">
                      <a href="#" class="thumbnail product-thumbnail">
                      <img src="{{asset('../'.$disc->varient_image)}}" alt="product-img">
                          <img class="product-img-extra change" alt="product-img" src="{{asset('../'.$disc->other_image)}}">
                      </a>
                      <div class="product-flags">
                        <div class="sale">Sale</div>
                      </div>
                    ...
                    <div class="caption">  
                      <p class="description">
                      {{$disc->en_description}}</p>
                      <p class="price">
                        <span class="regular price-old">{{$disc->mrp}}</span> 
                        <span class="price-discount">{{$disc->mrp - $disc->price}}</span> 
                        <span class="price-sale">{{$disc->price}}</span>
                      </p>
                      <div class="btn-cart">
                        <a href="direct_cart/{{$disc->vid}}/{{$disc->name}}" data-button-action="add-to-cart" class="button">
                              <i class="fa fa-shopping-cart"></i>
                              <span class="lblcart">Add to cart</span>
                            </a>
                      </div>                           
                      <div class="button-group">  
                        <div class="btn-quickview"> 
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$disc->pid}}/{{$disc->vid}}">                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                  <symbol id="eye-open" viewBox="0 0 1190 1190">
                                    <title>eye-open</title>
                                    <path
                                      d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z" />
                        ...
                        <div class="btn-wishlist">
                        <a href="direct_wish/{{$disc->vid}}/{{$disc->name}}">
                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                  <symbol id="heart-shape-outline" viewBox="0 0 1400 1400">
                                    <title>heart-shape-outline</title>
                                    <path
                ...
                <div class="product-thumb">
                  <div class="item">
                    ...
                    <div class="caption">  
                      ...
                      <div class="button-group">  
                        <div class="btn-quickview"> 
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$disc->pid}}/{{$disc->vid}}"> 
                            <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                              <symbol id="eye-open" viewBox="0 0 1190 1190"><title>eye-open</title><path d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z"/></symbol>
                            </svg>
                            <svg class="icon" viewBox="0 0 30 30"><use xlink:href="#eye-open" x="28%" y="28%"></use></svg>
                ...
                <div class="product-thumb">
                  <div class="item">
                    ...
                    <div class="caption">  
                      ...
                      <div class="button-group">  
                        <div class="btn-quickview"> 
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$pro->product_id}}">                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                  <symbol id="eye-open" viewBox="0 0 1190 1190">
                                    <title>eye-open</title>
                                    <path
                                      d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z" />
              ...
              <div class="product-thumb">
                  <div class="item">
                    ...
                    <div class="caption">  
                      ...
                      <div class="button-group">  
                        <div class="btn-quickview"> 
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$disc->pid}}">                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                  <symbol id="eye-open" viewBox="0 0 1190 1190">
                                    <title>eye-open</title>
                                    <path
                                      d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z" />
                ...
                <div class="product-thumb">
                  <div class="item">
                    ...
                    <div class="caption">  
                      ...
                      <div class="button-group">  
                        <div class="btn-quickview"> 
                        <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$disc->pid}}"> 
                            <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                              <symbol id="eye-open" viewBox="0 0 1190 1190"><title>eye-open</title><path d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z"/></symbol>
                            </svg>
                            <svg class="icon" viewBox="0 0 30 30"><use xlink:href="#eye-open" x="28%" y="28%"></use></svg>
      ...
      <!-- <section id="ishiparallaxbanner" class="clearfix">
        <div class="parallax" data-source-url="{{asset('assets/images/parallax.jpg')}}" style="background-image: url(https://ishithemes.com/);">    
          <div class="container">
      ...
      <section id="linkproductcategoryblock8" class="ishiproductsblock container">
        ...
        <ul id="ishiproductstab" class="nav nav-tabs clearfix">
          ...
          <!-- data-toggle="tab" -->
          <!-- data-id="{{$subcat->id}}" onclick="get_image()" -->
           <a class="nav-link @if($simage[0]->id == $subcat->id) active @endif" href="dpbsc/{{$subcat->id}}" data-id="{{$subcat->id}}" onclick="get_image()">{{$subcat->name}}</a>
         </li>
         @endforeach
        </ul>      
          <div class="tab-content">
              ...
              <div class="row">
                ...
                <div class="banner_productblock col-lg-3 col-md-3 hidden-md-down">
                  <a class="ishi-customhover-fadeinrotate home_Categories_aTag_style" href="category">
                    <img src="{{asset('../'.$si->image)}}" alt="banner">
                    <h2 class="text-center home_Categories_h2_style">{{$si->category_name}}</h2>
                ...
                <div class="block_content col-lg-9 col-md-12 col-sm-12 col-xs-12">
                  <div  id="ishi-products-category" class="owl-carousel d-flex">
                    @foreach($bysub as $bys)
                    @if($bys->current_stock > 0)                    
                    <div class="product-thumb">
                      <div class="item">
                        <div class="product-desc">
                          <div class="product-title"><a href="#">{{$bys->name}}</a></div>
                          <div class="product-comments">  
                            <div class="star_content">
                                <div class="star star_on"></div>
                                <div class="star star_on"></div>
                        ...
                        <div class="image">
                          <a href="#" class="thumbnail product-thumbnail">
                          <img src="{{asset('../'.$bys->varient_image)}}" alt="product-img">
                              <img class="product-img-extra change" alt="product-img" src="{{asset('../'.$bys->other_image)}}">
                          </a>
                          <div class="product-flags">
                            <div class="sale">Sale</div>
                          </div>
                        ...
                        <div class="caption">  
                          <p class="description">
                          {{$bys->en_description}}</p>
                          <p class="price">
                            <span class="regular price-old">{{$bys->mrp}}</span> 
                            <span class="price-discount">{{$bys->mrp - $bys->price}}</span> 
                            <span class="price-sale">{{$bys->price}}</span>
                          </p>
                          <div class="btn-cart">
                            <a href="direct_cart/{{$bys->vid}}/{{$bys->name}}" data-button-action="add-to-cart" class="button">
                                  <i class="fa fa-shopping-cart"></i>
                                  <span class="lblcart">Add to cart</span>
                                </a>
                          </div>                           
                          <div class="button-group">  
                            <div class="btn-quickview"> 
                            <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$bys->pid}}/{{$bys->vid}}">                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                      <symbol id="eye-open" viewBox="0 0 1190 1190">
                                        <title>eye-open</title>
                                        <path
                                          d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z" />
                            ...
                            <div class="btn-wishlist">
                            <a href="direct_wish/{{$bys->vid}}/{{$bys->name}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                      <symbol id="heart-shape-outline" viewBox="0 0 1400 1400">
                                        <title>heart-shape-outline</title>
                                        <path
                    ...
                    <div class="product-thumb">
                      <div class="item">
                        ...
                        <div class="caption">  
                          ...
                          <div class="button-group">  
                            <div class="btn-quickview"> 
                            <a class="quickbox" href="http://artybrainsdemo.com/mole/app.user/detail/{{$bys->pid}}/{{$bys->vid}}"> 
                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                                  <symbol id="eye-open" viewBox="0 0 1190 1190"><title>eye-open</title><path d="M505.918,236.117c-26.651-43.587-62.485-78.609-107.497-105.065c-45.015-26.457-92.549-39.687-142.608-39.687 c-50.059,0-97.595,13.225-142.61,39.687C68.187,157.508,32.355,192.53,5.708,236.117C1.903,242.778,0,249.345,0,255.818 c0,6.473,1.903,13.04,5.708,19.699c26.647,43.589,62.479,78.614,107.495,105.064c45.015,26.46,92.551,39.68,142.61,39.68 c50.06,0,97.594-13.176,142.608-39.536c45.012-26.361,80.852-61.432,107.497-105.208c3.806-6.659,5.708-13.223,5.708-19.699 C511.626,249.345,509.724,242.778,505.918,236.117z M194.568,158.03c17.034-17.034,37.447-25.554,61.242-25.554 c3.805,0,7.043,1.336,9.709,3.999c2.662,2.664,4,5.901,4,9.707c0,3.809-1.338,7.044-3.994,9.704 c-2.662,2.667-5.902,3.999-9.708,3.999c-16.368,0-30.362,5.808-41.971,17.416c-11.613,11.615-17.416,25.603-17.416,41.971 c0,3.811-1.336,7.044-3.999,9.71c-2.667,2.668-5.901,3.999-9.707,3.999c-3.809,0-7.044-1.334-9.71-3.999 c-2.667-2.666-3.999-5.903-3.999-9.71C169.015,195.482,177.535,175.065,194.568,158.03z M379.867,349.04 c-38.164,23.12-79.514,34.687-124.054,34.687c-44.539,0-85.889-11.56-124.051-34.687s-69.901-54.2-95.215-93.222 c28.931-44.921,65.19-78.518,108.777-100.783c-11.61,19.792-17.417,41.207-17.417,64.236c0,35.216,12.517,65.329,37.544,90.362 s55.151,37.544,90.362,37.544c35.214,0,65.329-12.518,90.362-37.544s37.545-55.146,37.545-90.362 c0-23.029-5.808-44.447-17.419-64.236c43.585,22.265,79.846,55.865,108.776,100.783C449.767,294.84,418.031,325.913,379.867,349.04 z"/></symbol>
                                </svg>
                                <svg class="icon" viewBox="0 0 30 30"><use xlink:href="#eye-open" x="28%" y="28%"></use></svg>
            ...
            <div id="ishitestimonials-carousel" class="owl-carousel">       
              <div class="item ishitestimonials-container">
                <div class="testimonial-img">
                  <img src="{{asset('assets/images/testimonial/testimonial-1.png')}}" alt="Marko Westin">
                </div>
              ...
              <div class="item ishitestimonials-container">
                <div class="testimonial-img">
                  <img src="{{asset('assets/images/testimonial/testimonial-2.png')}}" alt="John Duff">
                </div>
                <div class="testimonial-info">
                  <span class="quote">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 298.7 298.7" style="enable-background:new 0 0 298.7 298.7;" xml:space="preserve">
              ...
              <div class="item ishitestimonials-container">
                <div class="testimonial-img">
                  <img src="{{asset('assets/images/testimonial/testimonial-3.png')}}" alt="Marko Westin">
                </div>
                <div class="testimonial-info">
                  <span class="quote">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 298.7 298.7" style="enable-background:new 0 0 298.7 298.7;" xml:space="preserve">
              ...
              <div class="item ishitestimonials-container">
                <div class="testimonial-img">
                  <img src="{{asset('assets/images/testimonial/testimonial-4.png')}}" alt="Marko Westin">
                </div>
                <div class="testimonial-info">
                  <span class="quote">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 298.7 298.7" style="enable-background:new 0 0 298.7 298.7;" xml:space="preserve">
              ...
              <div class="item ishitestimonials-container">
                <div class="testimonial-img">
                  <img src="{{asset('assets/images/testimonial/testimonial-5.png')}}" alt="Marko Westin">
                </div>
                <div class="testimonial-info">
                  <span class="quote">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 298.7 298.7" style="enable-background:new 0 0 298.7 298.7;" xml:space="preserve">
          ...
          @foreach($blog as $blg)
           <div class="item blog_post">
              <div class="news_module_image_holder">
                <a href="blog_info/{{$blg->id}}">
                  <img alt="Upon of seasons earth dominion" class="feat_img_small" src="{{asset('assets/images/banner/'.$blg->image)}}">
                  <span class="blog-hover"></span>
                </a>
                <div class="date-comment">
                  <span class="blog_date"> <i class="fa fa-calendar"></i>{{$blg->created_at}}</span>
                  <span class="write-comment"> <a href="#"><i class="fa fa-comment"></i>&nbsp&nbsp{{$blg->no_of_comments}}&nbsp&nbspCOMMENTS</a></span>
                </div>
              </div>
              <div class="blog_content">
                <div class="blog_inner">
                  <h4 class="blog_title"><a href="blog_post.html">{{$blg->title}}</a></h4>
                  <p class="blog-desc">{{$blg->description}}</p>
                </div>
              </div>  
        ...
        <div class="row">
          <div class="bannerimage bannerblock col-lg-4 col-md-12 col-sm-12 col-xs-12">
            <a href="#" class="ishi-customhover-fadeinnormal scale">
              <img src="{{asset('assets/images/banner/5.png')}}" alt="banner" class="img-responsive" />
            </a>
          </div>
          ...
          <div class="bannerimage bannerblock col-lg-4 col-md-12 col-sm-12 col-xs-12">
            <a href="#" class="ishi-customhover-fadeinnormal scale">
            <img src="{{asset('assets/images/banner/6.png')}}" alt="banner" class="img-responsive" />
            </a>
          </div>
        </div>
      </section>
