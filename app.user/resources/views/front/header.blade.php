...
<head>
 ...
 <script src="https://kit.fontawesome.com/a076d05399.js" crossorigin="anonymous"></script>
  ...
  <script src="{{asset('assets/js/totalstorage.js')}}" type="text/javascript"></script>
  ...
  <script src="{{asset('assets/js/bxslider.js')}}" type="text/javascript"></script>
  <script src="{{asset('assets/js/ishi.initialize.js')}}" type="text/javascript"></script>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 right-nav">       
              <div class="userinfo-inner">
                ...
                @if(Session::get('user'))
                <li class="log-in">
                <a class="nav-item nav-link" href="http://artybrainsdemo.com/mole/app.user/profile/{{Session::get('user_id')}}">Welcome, {{Session::get('user')}}</a>
                  </li>
          @else
                      <li class="log-in">
        ...
        <div class="container">
          <div class="row"> 
            ...
            <div id="desktop_logo" class="col-lg-3 col-md-5 col-sm-12 col-xs-12">
              <a href="home">
                <img class="logo img-responsive" src="{{asset('assets/images/header-logo.png')}}" alt="Demo Shop">
              </a>
            </div>
              ...
              <div id="ishiservices" class="ishiservicesblock">
                <div class="ishiservices owl-carousel">        
                  <div class="services item">
                    <a href="#">
                      <div class="service-img" style="background-image: url({{asset('assets/images/services/1.png')}});">
                      </div>
                  ...
                  <div class="services item">
                    <a href="#">
                      <div class="service-img" style="background-image: url({{asset('assets/images/services/2.png')}});">
                      </div>
                      <div class="service-block">
                  ...
                  <div class="services item">
                    <a href="#">
                      <div class="service-img" style="background-image: url({{asset('assets/images/services/3.png')}});">
                      </div>
                      <div class="service-block">
                  ...
                  <div class="services item">
                    <a href="#">
                      <div class="service-img" style="background-image: url({{asset('assets/images/services/4.png')}});">
                      </div>
                      <div class="service-block">
                  ...
                  <div class="cart-dropdown">
                    <div class="product-container">
                      ...
                      <div class="product">
                        <a class="product-image" href="#">
                          <img src="{{asset('assets/images/product/'.$product['image'])}}" alt="Simul dolorem voluptaria">
                        </a>
                        <div class="product-detail">
                          <div class="product-name">
                            ...
                            <a class="cart_block_product_name" href="#">{{$product['name']}}</a>
                          </div>
                          <div class="price">{{$product['quantity']*$product['price']}}</div>
                        ...
                        <div class="remove-product">
                          <a class="remove-from-cart" rel="nofollow" href="detail_dltcart/{{$id}}">
                    ...
                    @foreach(session('cart') as $id => $product)
                      ...
                      <div class="billing shipping-info">
                        ...
                        <span class="value">@if($total >= $product['shipping'])
                        0
                        @else
                        {{$product['shipping']}}
                        @endif</span>
