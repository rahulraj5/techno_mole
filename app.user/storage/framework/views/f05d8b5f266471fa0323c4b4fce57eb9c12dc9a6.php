					...
					<div class="card-body p-5">
						...
						<?php echo e(csrf_field()); ?>
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" name="encoupon_name" required>
							</div>
							<div class="col-md-6">
								<label for="inputLastName" class="form-label">Coupon Arabic Name</label>
								<input type="text" class="form-control" name="arcoupon_name" style="text-align: right;" required>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<input class="result form-control" type="text" name="valid_from" id="date-time-from" data-dtp="dtp_nr8Un" required>
							</div>
							
							<div class="col-md-6">
								<label class="form-label">Valid To</label>
								<input class="result form-control" type="text" name="valid_to" id="date-time-to" data-dtp="dtp_nr8Un" required>
							</div>
							...
							<div class="col-md-6">
								...
								<input type="text" class="form-control" name="cart_value" required>
							</div>
							<div class="col-md-6">
								<label for="inputLastName" class="form-label">Coupon Restriction</label>
								<input type="number" class="form-control" name="restriction" required>
							</div>
							<div class="col-md-6">
								<label for="inputLastName" class="form-label">Coupon Type</label>
								<input type="text" class="form-control" name="coupon_type" required>
							</div>
							<div class="col-md-6">
								<label for="inputLastName" class="form-label">Coupon English Description</label><br>
								<textarea id="mytextarea" name="encoupon_desc" cols="64" required></textarea>
							</div>
							<div class="col-md-6">
								<label for="inputLastName" class="form-label">Coupon Arabic Description</label><br>
								<textarea id="mytextarea" name="arcoupon_desc" cols="64" style="text-align: right;" required></textarea>
							</div>
							<div class="col-md-6">
								<label for="inputLastName" class="form-label">Coupon Image</label><br>
								<input id="cat_img" type="file" name="coupon_image" required>
							</div>
							<div class="col-12">
