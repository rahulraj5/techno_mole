                       ...
                       <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li <?php if($key === 0): ?> class="active" <?php endif; ?> data-depth="0">
                          ...
                          <div class="collapse" id="exCollapsingNavbar4<?php echo e($key+1); ?>">
                            ...
                            <?php $__currentLoopData = $other; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li data-depth="1">
                               <a class="category-sub-link" data-id="<?php echo e($subcats->id); ?>" href="/bycatpro/<?php echo e($cat->id); ?>/<?php echo e($subcats->id); ?>" onclick="edit()"><?php echo e($subcats->name); ?></a>
                               </li>
            ...
            <section id="main">
              ...
              <section id="productdata" class="category-product-info">
                ...
                <div id="js-product-list">
                  ...
                  <?php $__currentLoopData = $subcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($pro->current_stock > 0): ?>
                      ...
                      <div class="product-container product-thumb">
                        ...
                        <div class="product-desc">
                          <div class="product-title"><a href="#"><?php echo e($pro->product_name); ?></a></div>
                      ...
                      <div class="product-container product-thumb">
                        <a href="productpage_leftcolumn.html">
                          <div class="product-desc">
                            ...
                            <div class="product-title"><a href="productpage_leftcolumn.html"><?php echo e($pro->product_name); ?></a></div>
                            <div class="product-comments">
                              <div class="star_content">
                                <div class="star star_on">
