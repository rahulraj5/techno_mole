          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 right-nav">       
              <div class="userinfo-inner">
                ...
                <li class="log-in">
                <a class="nav-item nav-link" href="http://localhost/mole2/profile/<?php echo e(Session::get('user_id')); ?>">Welcome, <?php echo e(Session::get('user')); ?></a>
                  </li>
          <?php else: ?>
                      <li class="log-in">
                    <a href="http://localhost/mole2/login" id="customer_login_link">Log in</a>
                  </li>
                  <li class="create_account">
                    <a href="http://localhost/mole2/ureg" id="customer_register_link">Create Account</a>
                  </li>   

            <?php endif; ?>
                   
                  <li class="wishlist">
                    <a href="http://localhost/mole2/wish">Wishlist</a>
                  </li>
                  <li class="checkout">
                  ...
                  <?php if(Session::get('user')): ?>
                <li class="logout">
                <a class="nav-item nav-link" href="http://localhost/mole2/logout">Logout</a>
                  </li>
          <?php endif; ?>
                </ul>
              </div>  
          ...
          <div class="row">
            ...
            <ul class="top-menu" id="top-menu" data-depth="0">  
                <li class="cms-page" id="category-12">
                  <a class="dropdown-item" href="http://localhost/mole2/home" data-depth="0">
                    Home
                  </a>
                </li>
                <li class="cms-page" id="cms-page-4">
                  <a class="dropdown-item" href="http://localhost/mole2/about" data-depth="0">
                    About us
                  </a>
                </li>
              
                <li class="category" id="category-3">
                  <a class="dropdown-item" href="http://localhost/mole2/category" data-depth="0">
                    Category
                  </a>
                </li>
                ...
                <li class="category" id="category-1111">
                  <a class="dropdown-item" href="http://localhost/mole2/blog" data-depth="0">Blog</a>
                 
                </li>
                <li class="cms-page" id="cms-page-1">
                  <a class="dropdown-item" href="http://localhost/mole2/contact" data-depth="0">
                    Contact us
                  </a>
                </li>
              </ul>
                  ...
                  <div class="cart-dropdown">
                   ...
                   <?php endif; ?> 
                    ...
                    <div class="cart-btn col-xs-12">
                      <a href="ac" class="btn btn-primary checkout">Add to Cart</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="contact-num">
              <a href="http://localhost/mole2/contact">
                <div class="call-img">
                  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
