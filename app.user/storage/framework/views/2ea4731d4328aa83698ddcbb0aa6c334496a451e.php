				...
				<div class="card border-top border-0 border-4 border-primary">
					<div class="card-body p-5">
						...
						<?php if(count($errors) > 0): ?>
							...
							<?php endif; ?>
						<?php endif; ?>
						<form class="row g-3" action="<?php echo e(url('category_add')); ?>" method="post" enctype="multipart/form-data">
						<?php echo e(csrf_field()); ?>

							<div class="col-md-6">
								<label for="inputLastName" class="form-label">English Category Name</label>
								<input type="text" class="form-control"  name="encat_name" required>
							</div>
							<div class="col-md-6">
								<label for="inputLastName" class="form-label">Arabic Category Name</label>
								<input type="text" class="form-control"  name="arcat_name" style="text-align: right;" required>
							</div>
							<div class="col-md-6">
								<label for="inputEmail" class="form-label">Image</label><br>
								<input id="cat_img" type="file" name="cat_image" required>
							</div>
