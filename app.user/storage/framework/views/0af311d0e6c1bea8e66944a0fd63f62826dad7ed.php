			...
			<div class="ps-3">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0 p-0">
						<li class="breadcrumb-item"><a href="<?php echo e(url('/primary_banner')); ?>"><i class="bx bx-home-alt"></i></a></li>
						<li class="breadcrumb-item active" aria-current="page">Edit Primary Banner</li>
					</ol>
				</nav>
			</div>
		</div>				
				...
				<div class="card border-top border-0 border-4 border-primary">
					<div class="card-body p-5">
						<div class="card-title d-flex align-items-center">
							...
							<h5 class="mb-0 text-primary">Edit Primary Banner</h5>
						</div>
						<hr>
						...
						<?php if(count($errors) > 0): ?>
							...
							<?php endif; ?>
						<?php endif; ?>
						<form class="row g-3" action="<?php echo e(url('update_primary_banner')); ?>" method="post" enctype="multipart/form-data">
						<?php echo e(csrf_field()); ?>

							<input type="hidden" name="banner_id" value="<?php echo e($banner->banner_id); ?>" >
