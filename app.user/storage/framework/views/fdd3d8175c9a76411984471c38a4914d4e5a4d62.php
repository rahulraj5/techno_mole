							...
							<div class="card">
								<div class="card-header">
									...
									<div class="graph-day-selection" role="group">
										<button type="button" class="btn active"><a href="add/models/<?php echo e($title); ?>/<?php echo e($tbl_name); ?>"><i class="icon-add"></i>Add New Model</a></button>
									</div>
								</div>
								<div class="card-body">
										...
										<table class="table products-table">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo e($model->brand_name); ?></td>
													<td>
													    <?php if($model->status == 1): ?>
														    <a href="changeStatus/id/<?php echo e($tbl_name); ?>/<?php echo e($model->id); ?>/0"><span class="badge bg-success">Published</span></a>
														<?php else: ?>
														    <a href="changeStatus/id/<?php echo e($tbl_name); ?>/<?php echo e($model->id); ?>/1"><span class="badge bg-danger">UnPublished</span></a>
														<?php endif; ?>
													...
													<td>
														<div class="actions">
															...
															<a href="delete/id/<?php echo e($tbl_name); ?>/<?php echo e($model->id); ?>" onclick="return confirm('Are you sure?')" data-toggle="tooltip" data-placement="top"
