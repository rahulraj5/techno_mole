<?php $__env->startSection('content'); ?>
            ...
            <div id="left-column">
              <div class="category-block-container">
                ...
                <h3 class="hidden-md-down">
                  ...
                  <a class="block-title text-uppercase h6" href="#"><?php echo e($cat->name); ?></a>
                  <?php break; ?>
                ...
                <div id="subcategories-container" class="block-categories collapse data-toggler">
                  <ul class="category-top-menu">
                    <li>
                      ...
                      <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li data-depth="1">
                                <a class="category-sub-link" href="/bycat/<?php echo e($cat->id); ?>"><?php echo e($cat->sname); ?></a>
                              </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
              ...
              <section class="featured-products clearfix mt-3">
                ...
                <div id="newproducts-container" class="collapse data-toggler">
                  <div class="products">
                    <?php $__currentLoopData = $latestproduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="product-miniature js-product-miniature">
                      <div class="product-container">
                        <div class="image">
                          <a href="/detail/<?php echo e($lp->pid); ?>/<?php echo e($lp->varient_id); ?>" class="thumbnail product-thumbnail">
                            <img src="<?php echo e(asset('assets/images/product/'.$lp->photos)); ?>" alt="Pellentesque et pharetra">
                          </a>
                        </div>
                        <div class="caption">
                          <div class="product-title"><a href="#"><?php echo e($lp->name); ?></a></div>
                          <div class="product-price-and-shipping">
                             <span class="discount-percentage discount-product"><?php echo e($lp->product_info); ?></span>
                          </div>
                        </div>
                      </div>
                    </article>
              ...
              <div id="ishileftbanners" class="clearfix">
                <div class="image-container">
                  <a class="ishi-customhover-fadeinflip" href="#">
                    <img src="<?php echo e(asset('assets/images/leftbanner.jpg')); ?>" / alt="leftbanner1">
                  </a>
                </div>
              </div>
              <section class="featured-products clearfix mt-3">
                  ...
                  <div class="products">
                      ...
                      <div class="product-container">
                        <div class="image">
                          <a href="#" class="thumbnail product-thumbnail">
                            <img src="<?php echo e(asset('assets/images/product/5.jpg')); ?>" alt="Pellentesque et pharetra">
                          </a>
                        </div>
                        <div class="caption">
                    ...
                    <article class="product-miniature js-product-miniature">
                      <div class="product-container">
                        <div class="image">
                          <a href="#" class="thumbnail product-thumbnail">
                            <img src="<?php echo e(asset('assets/images/product/6.jpg')); ?>" alt="Pellentesque et pharetra">
                          </a>
                        </div>
                        <div class="caption">
                    ...
                    <article class="product-miniature js-product-miniature">
                      <div class="product-container">
                        <div class="image">
                          <a href="#" class="thumbnail product-thumbnail">
                            <img src="<?php echo e(asset('assets/images/product/7.jpg')); ?>" alt="Pellentesque et pharetra">
                          </a>
                        </div>
                        <div class="caption">
                    ...
                    <article class="product-miniature js-product-miniature">
                      <div class="product-container">
                        <div class="image">
                          <a href="#" class="thumbnail product-thumbnail">
                            <img src="<?php echo e(asset('assets/images/product/8.jpg')); ?>" alt="Pellentesque et pharetra">
                          </a>
                        </div>
                        <div class="caption">
    ...
    <div class="product-cover">
     <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div id="product-zoom">
        <img class="js-qv-product-cover" src="<?php echo e(asset('assets/images/product/'.$pro->varient_image)); ?>" alt="product-image"
      ...
      <div class="js-qv-mask mask">
        ...
        <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <li class="thumb-container item">
            <img class="thumb js-thumb  selected " src="<?php echo e(asset('assets/images/product/'.$pro->varient_image)); ?>"
              alt="related-items" title="" data-image-large-src="<?php echo e(asset('assets/images/product/'.$pro->varient_image)); ?>"
          ...
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <ul>
                        <li>
                          <div class="block-reassurance-item">
                            <img src="<?php echo e(asset('assets/images/block-reassurance/1.png')); ?>"
                        ...
                        <li>
                          <div class="block-reassurance-item">
                            <img src="<?php echo e(asset('assets/images/block-reassurance/2.png')); ?>"
                        ...
                        <li>
                          <div class="block-reassurance-item">
                            <img src="<?php echo e(asset('assets/images/block-reassurance/3.png')); ?>"
                ...
                <div class="col-md-6 productfullldetails">
                  <h1 class="h1 product-title"><?php echo e($pro->product_name); ?></h1>
                  <div class="product-information">
                    <div id="product-description-short-1">
                      <!-- <p id="description"><?php echo e($pro->en_description); ?></p> -->
                    </div>
                    ...
                    <div class="product-actions">
                      ...
                      <input type="hidden" name="pid" value="<?php echo e($pro->product_id); ?>">
                      <input type="hidden" name="pname" value="<?php echo e($pro->product_name); ?>">
                        ...
                        <div class="product-variants">
                         <div class="clearfix product-variants-item">
                            ...
                            <select class="form-control-select" id="group_1" data-product-attribute="1" name="size" onchange="getState(this.value)" required>
                             <?php $__currentLoopData = $psize; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option value="<?php echo e($pro->size_id); ?>" <?php echo e($s->size == $pro->size_id ? 'selected' : ''); ?>><?php echo e($pro->size_name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
                          ...
                          <div class="clearfix product-variants-item">
                            ...
                            <?php $__currentLoopData = $pcolor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $size; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li class="float-xs-left input-container">
                                <label>
                                  <input type="radio" name="color" value="<?php echo e($pro->color_id); ?>" <?php echo e($s->color == $pro->color_id ? 'checked' : ''); ?>><?php echo e($pro->color_name); ?>

                                  <!-- <input class="input-color" type="radio" data-product-attribute="3" name="color"
                                    value="<?php echo e($pro->color_id); ?>">
                                  <span class="color" style="background-color:<?php echo e($pro->color_code); ?>">
                        ...
                        <div class="product-prices">
                          <div class="product-price h5">
                            ...
                            <div class="current-price" >
                              <span itemprop="price" id="message"><?php echo e($s->price); ?></span>
                              </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                          </div>
                        ...
                        <div class="product-additional-info">
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 paymentlogo-container">
                            <span>Payment</span>
                            <img src="<?php echo e(asset('assets/images/paymenticon/1.png')); ?>" alt="Discover" />
                            <img src="<?php echo e(asset('assets/images/paymenticon/2.png')); ?>" alt="Visa" />
                            <img src="<?php echo e(asset('assets/images/paymenticon/3.png')); ?>" alt="JCB" />
                            <img src="<?php echo e(asset('assets/images/paymenticon/4.png')); ?>" alt="PayPal" />
                            <img src="<?php echo e(asset('assets/images/paymenticon/5.png')); ?>" alt="Master Card" />
                            <img src="<?php echo e(asset('assets/images/paymenticon/6.png')); ?>" alt="American Express" />
                          </div>
                        </div>
                      </form>
                    </div>
                  ...
                  <div class="tabs">
                    ...
                    <div class="tab-content" id="tab-content">
                      ...
                      <div class="product-description">
                          <p id="ajax_descrip"><?php echo e($pro->en_description); ?></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </div>
                      <div class="tab-pane fade" id="product-details" role="tabpanel">
                        <div class="product-manufacturer">
                          <a href="#">
                            <img src="<?php echo e(asset('assets/images/product-brandlogo.png')); ?>" class="img img-thumbnail manufacturer-logo"
                ...
                <section class="product-accessories-block clearfix">
                  ...
                  <div class="block_content">
                    <div id="ishi-left-right-product-accessories" class="owl-carousel">
                      <?php $__currentLoopData = $vproduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($vp->current_stock > 0): ?>                    
                    <div class="product-thumb">
                      <div class="item">
                        <div class="product-desc">
                          <div class="product-title"><a href="#"><?php echo e($vp->name); ?></a></div>
                        ...
                        <div class="image">
                          <a href="#" class="thumbnail product-thumbnail">
                          <img src="<?php echo e(asset('assets/images/product/'.$vp->varient_image)); ?>" alt="product-img">
                              <img class="product-img-extra change" alt="product-img" src="<?php echo e(asset('assets/images/product/'.$vp->other_image)); ?>">
                          </a>
                        ...
                        <div class="caption">  
                          <p class="description">
                          <?php echo e($vp->en_description); ?></p>
                          <p class="price">
                            <span class="regular price-old"><?php echo e($vp->mrp); ?></span> 
                            <span class="price-discount"><?php echo e($vp->mrp - $vp->price); ?></span> 
                            <span class="price-sale"><?php echo e($vp->price); ?></span>
                          </p>
                          <div class="btn-cart">
                            <a href="/direct_cart/<?php echo e($vp->varient_id); ?>/<?php echo e($vp->name); ?>" data-button-action="add-to-cart" class="button">
                          ...
                          <div class="button-group">  
                            ...
                            <a class="quickbox" href="/detail/<?php echo e($vp->product_id); ?>">                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                            ...
                            <a href="/direct_wish/<?php echo e($vp->varient_id); ?>/<?php echo e($vp->name); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                    ...
                    <div class="product-thumb">
                      <div class="item">
                        ...
                        <div class="caption">  
                          ...
                          <div class="button-group">  
                            <div class="btn-quickview"> 
                            <a class="quickbox" href="/detail/<?php echo e($vp->product_id); ?>"> 
                                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
