			...
			<div class="ps-3">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0 p-0">
						...
						<li class="breadcrumb-item active" aria-current="page">Add Secondary Banner</li>
					</ol>
				</nav>
			</div>
		</div>				
				...
				<div class="card border-top border-0 border-4 border-primary">
					<div class="card-body p-5">
						<div class="card-title d-flex align-items-center">
							...
							<h5 class="mb-0 text-primary">Add Secondary Banner</h5>
						</div>
						<hr>
						...
						<?php if(count($errors) > 0): ?>
							...
							<?php endif; ?>
						<?php endif; ?>
						<form class="row g-3" action="<?php echo e(url('secondarybanner_add')); ?>" method="post" enctype="multipart/form-data">
