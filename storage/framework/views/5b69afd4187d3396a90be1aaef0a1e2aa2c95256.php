				...
				<div class="card border-top border-0 border-4 border-primary">
					<div class="card-body p-5">
						...
						<?php if(count($errors) > 0): ?>
							...
							<?php endif; ?>
						<?php endif; ?>
						<form class="row g-3" action="<?php echo e(url('update_charge')); ?>" method="post" enctype="multipart/form-data">
						<?php echo e(csrf_field()); ?>

							
							<div class="col-md-6">
								<label for="inputLastName" class="form-label">Cart Value</label>
								<input type="number" class="form-control" name="min_cart_value" value="<?php echo e($del_charge->min_cart_value); ?>" required>
							</div>
							<div class="col-md-6">
								<label for="inputLastName" class="form-label">Delivery Charge</label>
								<input type="number" class="form-control" name="del_charge" value="<?php echo e($del_charge->del_charge); ?>" required>
							</div>
							<div class="col-12">
