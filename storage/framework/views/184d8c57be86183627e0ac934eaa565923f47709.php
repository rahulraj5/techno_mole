					...
					<div class="card-body p-5">
						...
						<?php echo e(csrf_field()); ?>
							...
							<div class="col-md-6">
								...
								<textarea id="summernote1" name="eng_info"><?php echo e($product->product_info); ?></textarea>
							</div>
							
							<div class="col-md-6">
							<label for="inputLastName" class="form-label">Arabic Information</label><br>
							<textarea id="summernote2" name="ar_info" style="text-align: right; margin-left: auto; background-color: transparent;"><?php echo e($product->ar_product_info); ?></textarea>
							</div>
